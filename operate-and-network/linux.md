...
* [Linux Mint](https://zh.wikipedia.org/wiki/Linux_Mint)，使用[Cinnamon](https://zh.wikipedia.org/wiki/Cinnamon)桌面系统的Ubuntu派生版。
* [Knoppix](https://zh.wikipedia.org/wiki/Knoppix)，第一个[Live CD](https://zh.wikipedia.org/wiki/Live_CD)发行版，可以从[可移动介质](https://zh.wikipedia.org/w/index.php?title=可移动介质&action=edit&redlink=1)运行，Debian的派生版。
* [OpenGEU](https://zh.wikipedia.org/w/index.php?title=OpenGEU&action=edit&redlink=1)，Ubuntu的派生版。
* \[Elementary OS\]\([https://zh.wikipedia.org/wiki/Elementary\_\(操作系统\)\)：基于\[Ubuntu\]\(https://zh.wikipedia.org/wiki/Ubuntu\)，图形界面酷似\[Mac](https://zh.wikipedia.org/wiki/Elementary_%28操作系统%29%29：基于[Ubuntu]%28https://zh.wikipedia.org/wiki/Ubuntu%29，图形界面酷似[Mac) OS X\]\([https://zh.wikipedia.org/wiki/OS\_X\)。](https://zh.wikipedia.org/wiki/OS_X%29。)
* [gOS](https://zh.wikipedia.org/wiki/GOS)和其他[上网本](https://zh.wikipedia.org/wiki/上网本)用的系统。
...
* [Loongnix](https://zh.wikipedia.org/wiki/Loongnix)，从[Fedora](https://zh.wikipedia.org/wiki/Fedora)发展而来的发行版。
...
* [CentOS](https://zh.wikipedia.org/wiki/CentOS)，从[Red Hat](https://zh.wikipedia.org/wiki/Red_Hat)发展而来的发行版，由[志愿者](https://zh.wikipedia.org/wiki/志愿者)维护，旨在提供开源的，并与Red Hat 100%兼容的系统。
* [Mageia](https://zh.wikipedia.org/wiki/Mageia)，从[Mandriva](https://zh.wikipedia.org/wiki/Mandriva_Linux)发展而来的发行版。
* [Loongnix](https://zh.wikipedia.org/wiki/Loongnix)，从[Fedora](https://zh.wikipedia.org/wiki/Fedora)发展而来的发行版。

**基于其他包格式**

* [ArchLinux](https://zh.wikipedia.org/wiki/ArchLinux)，一个基于[KISS](https://zh.wikipedia.org/wiki/KISS原则)（Keep It Simple and Stupid）的滚动更新的操作系统。
* [Chakra](https://zh.wikipedia.org/wiki/Chakra_GNU/Linux)，一个从[ArchLinux](https://zh.wikipedia.org/wiki/ArchLinux)派生出来，只使用KDE桌面的半滚动更新发行版。
